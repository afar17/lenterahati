...
class Pendaftaran_model extends CI_Model {
    ...
    var $column_order = array(null, 'nik_siswa','nm_lengkap','nm_panggilan','nm_ayah','nm_ibu'); //set column field database for datatable orderable
    var $column_search = array('nm_lengkap','nm_panggilan','nm_ayah','nm_ibu'); //set column field database for datatable searchable 
